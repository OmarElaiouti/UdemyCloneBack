        ...
        public async Task<RegistrationResult> RegisterAsync(RegisterDto model)
        {
            ...
            try
            {
                ...
                if (!roleExists)
                {
                    ...
                    var roleResult = await _roleManager.CreateAsync(new IdentityRole(Roles.Student));
                ...
                var addToRoleResult = await _userManager.AddToRoleAsync(newUser, Roles.Student);
